...
#
# Commands:
#   hubot fight crime - Make a crime fighting duo!
...
module.exports = (robot) ->
    robot.respond /fight ?crime/i, (msg) ->
        parts = (c[Math.floor(Math.random()*c.length)] for c in he.concat(she))
        msg.send "He's #{parts[0..3].join ' '} She's #{parts[4..7].join ' '} #{close}"
